...
DROP TABLE IF EXISTS gp_results;
DROP TABLE IF EXISTS circuits_laps;
...
SELECT driver,
        ...
        pos_num
FROM gp_results
ORDER BY driver SEGMENTED BY HASH(grand_prix) ALL NODES;
...
SELECT constructor,
        ...
        pos_num
FROM gp_results
ORDER BY constructor SEGMENTED BY HASH(grand_prix) ALL NODES;
